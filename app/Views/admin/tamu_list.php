...
<div class="container-xxl mt-5" id="kt_content_container"
     data-url-dt="<?= base_url('admin/tamu/dt') ?>"
     data-url-bulk-delete="<?= base_url('admin/api/bulk-delete') ?>"
     data-url-update="<?= base_url('admin/tamu/update/') ?>"
     data-url-store="<?= base_url('admin/tamu/store') ?>"
     data-url-delete="<?= base_url('admin/tamu/delete/') ?>"
...
<!-- Scripts moved to admin_tamu.js -->
